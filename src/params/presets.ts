...
export const BUILTIN_PRESETS: readonly Preset[] = [
  {
    ...
    params: make({
      ...
      ambient: 0.02, palette: 0, contrast: 1.2, grain: 0.006,
  ...
  },
  {
    ...
    params: make({
      ...
      ambient: 0.02, palette: 2, iriAmount: 0.6, iriFreq: 0.8, hueShift: -25,
  ...
  },
  {
    ...
    params: make({
      ...
      ambient: 0.0, palette: 0, exposure: -0.3, contrast: 1.8, blackLevel: 0.2,
  ...
  },
  {
    ...
    params: make({
      ...
      ambient: 0.0, palette: 1, colorA: '#dfe8ff', colorB: '#05060b',
  ...
  },
  {
    ...
    params: make({
      ...
      ambient: 0.0, palette: 2, iriAmount: 0.5, iriFreq: 1.2, saturation: 1.2,
